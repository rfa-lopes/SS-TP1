...
{ "ER_TRUNCATED_WRONG_VALUE_FOR_FIELD", 1366, "Incorrect %-.32s value: \'%-.128s\' for column `%.192s`.`%.192s`.`%.192s` at row %lu" },
...
{ "ER_GALERA_REPLICATION_NOT_SUPPORTED", 4165, "DDL-statement is forbidden as table storage engine does not support Galera replication" },
